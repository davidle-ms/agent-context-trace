...
| `npm run test:unit` | Nineteen tests covering repository/wiki evidence, Markdown sections, preview limits and redaction, work-item reads/batches/comments, safe links, plus file coverage, history replay, scope, persistence, and attribution. |
